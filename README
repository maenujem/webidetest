...
* copy from https://download.eclipse.org/orion/drops/R-10.0-201510301610/index.html ./eclipse/orion and ./eclipse/plugins/org.eclipse.equinox.launcher.gtk.linux.x86_64_1.1.200.v20140603-1326 to WebIDE ./eclipse/..
* modify orion.ini 
``--launcher.library
